...
namespace WindowsApplication1
{
    ...
    public class Filters : Form
    {
        ...
        private void Filters_Load(object sender, EventArgs e)
        {
            ...
            // Clear RichTextBox1 and add empty lines
            string[] lines1 = this.RichTextBox1.Lines;
            ...
            // Clear RichTextBox2 and add empty lines
            string[] lines2 = this.RichTextBox2.Lines;
