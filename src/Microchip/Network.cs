...
namespace WindowsApplication1
{
	...
	public class Network : Form
	{
		...
		private virtual LIN OnAnswerSource
		{
			get
			{
		...
		private virtual LIN OnReceiveSource
		{
			get
			{
		...
		private void InitializeComponent()
		{
			...
			this.MessageLstBox.Items.AddRange(new object[] { "20 00 22 33 44", "3C 00 00 00 00 00 00 00 00" });
		...
		private void PrintDocument1_PrintPage(object sender, PrintPageEventArgs e)
		{
			int num;
			int num1;
			System.Drawing.Font font = new System.Drawing.Font(this.TextBox1.Font.Name, 8f);
			...
			string str = Strings.Mid(this.TextBox1.Text, checked(this.$STATIC$PrintDocument1_PrintPage$20211C1280B1$intCurrentChar + 1));
			SizeF sizeF = new SizeF((float)width, (float)height);
			graphics.MeasureString(str, font, sizeF, stringFormat, out num, out num1);
			e.Graphics.DrawString(Strings.Mid(this.TextBox1.Text, checked(this.$STATIC$PrintDocument1_PrintPage$20211C1280B1$intCurrentChar + 1)), font, Brushes.Black, rectangleF, stringFormat);
			this.$STATIC$PrintDocument1_PrintPage$20211C1280B1$intCurrentChar = checked(this.$STATIC$PrintDocument1_PrintPage$20211C1280B1$intCurrentChar + num);
			if (this.$STATIC$PrintDocument1_PrintPage$20211C1280B1$intCurrentChar >= this.TextBox1.Text.Length)
			{
				e.HasMorePages = false;
				this.$STATIC$PrintDocument1_PrintPage$20211C1280B1$intCurrentChar = 0;
			}
			else
			{
				e.HasMorePages = true;
		...
		private void SaveToolStripMenuItem_Click(object sender, EventArgs e)
		{
			int i;
			string str = "";
			string str1 = "COMMInterface";
			string str2 = "USBport";
			string str3 = Conversions.ToString(this.SelectedCOMport);
			if ((long)(-WindowsApplication1.Network.WritePrivateProfileString(ref str1, ref str2, ref str3, ref this.INIpath)) == (long)0)
			{
				Interaction.MsgBox("Error", MsgBoxStyle.OkOnly, "Save .config error");
			}
			str3 = "LINInterface";
			str2 = "Speed";
			str1 = this.MasterBaudRate.ToString();
			if ((long)(-WindowsApplication1.Network.WritePrivateProfileString(ref str3, ref str2, ref str1, ref this.INIpath)) == (long)0)
			{
				Interaction.MsgBox("Error", MsgBoxStyle.OkOnly, "Save .config error");
			}
			str3 = "LINInterface";
			str2 = "Timeout";
			str1 = Conversions.ToString(LIN.Get_OnReceive_Timeout());
			if ((long)(-WindowsApplication1.Network.WritePrivateProfileString(ref str3, ref str2, ref str1, ref this.INIpath)) == (long)0)
			{
				Interaction.MsgBox("Error", MsgBoxStyle.OkOnly, "Save .config error");
			}
			int count = checked(this.MessageLstBox.Items.Count - 1);
			for (i = 0; i <= count; i = checked(i + 1))
			{
				str3 = "LINMstrCommands";
				str2 = string.Concat("Message", i.ToString());
				str1 = this.MessageLstBox.Items[i].ToString();
				if ((long)(-WindowsApplication1.Network.WritePrivateProfileString(ref str3, ref str2, ref str1, ref this.INIpath)) == (long)0)
				{
					Interaction.MsgBox("Error", MsgBoxStyle.OkOnly, "Save .config error");
				}
			}
			int num = checked(MyProject.Forms.Slave.MessageLstBox.Items.Count - 1);
			for (i = 0; i <= num; i = checked(i + 1))
			{
				str3 = "LINSlaveCommands";
				str2 = string.Concat("Message", i.ToString());
				str1 = MyProject.Forms.Slave.MessageLstBox.Items[i].ToString();
				if ((long)(-WindowsApplication1.Network.WritePrivateProfileString(ref str3, ref str2, ref str1, ref this.INIpath)) == (long)0)
				{
					Interaction.MsgBox("Error", MsgBoxStyle.OkOnly, "Save .config error");
				}
			...
			str3 = "LogFile";
			str2 = "FilePath";
			if ((long)(-WindowsApplication1.Network.WritePrivateProfileString(ref str3, ref str2, ref this.LOGpath, ref this.INIpath)) == (long)0)
			{
				Interaction.MsgBox("Error", MsgBoxStyle.OkOnly, "Save .config error");
			}
			...
			if (LIN.Listen_mode_Is_Set())
			{
				str = "Listen";
			}
			if (LIN.DisplayAll_mode_Is_Set())
			{
				str = "DisplayAll";
			}
			str3 = "Transaction Mode";
			str2 = "Mode";
			if ((long)(-WindowsApplication1.Network.WritePrivateProfileString(ref str3, ref str2, ref str, ref this.INIpath)) == (long)0)
			{
				Interaction.MsgBox("Error", MsgBoxStyle.OkOnly, "Save .config error");
			}
		}
		...
		private void Timer1_Tick(object sender, EventArgs e)
		{
			...
			if (this.MessageLstBox.SelectedIndex != -1)
			{
				...
				while (num4 <= length)
				{
					if (Operators.CompareString(Conversions.ToString(charArray[num4]), ";", false) != 0)
					{
						...
						if (num2 < 10)
						{
							if (num2 == 0)
							{
								num = checked((byte)Math.Round(Conversion.Val(str)));
							}
							else
							{
				...
				num = this.GenParityBits(num);
				if (this.enhancedRadioButton.Checked)
				{
					num3 = checked(num3 + num);
					if (num3 >= 256)
					{
						num3 = checked(num3 - 255);
					}
